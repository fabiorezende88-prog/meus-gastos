...
let b=B[M]||0,avail=b-tot;$("spent").textContent=b?(avail>=0?money(avail):"- "+money(-avail)):"Sem orçamento";$("available").textContent="";$("progress").style.width=(b?Math.min(tot/b*100,100):0)+"%";$("progress").classList.toggle("danger",b&&tot>b);
